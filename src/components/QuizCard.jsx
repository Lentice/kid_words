...
export default function QuizCard({ dir, q, getWordFontSize, replayAudio, options, selectedOption, correct, setSelectedOption, setCorrect, setCount, setScore, makeQuestion, writeQuizState, qs, answerType, answer, setAnswer, check, next }) {
  if (!q) return null;
  return (
